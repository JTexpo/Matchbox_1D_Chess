...
class Board:
    def __init__(self):
        ...
        self.board:List[ChessPiece] = self._get_new_board()
    ...
    def _get_new_board(self) -> List[ChessPiece]:
        ...
        return [
            # Whites Side
            ChessPiece(name="white_king", team_id=WHITE_TEAM_ID, piece_id=KING_PIECE_ID),
            ChessPiece(name="white_knight", team_id=WHITE_TEAM_ID, piece_id=KNIGHT_PIECE_ID),
            ChessPiece(name="white_rook", team_id=WHITE_TEAM_ID, piece_id=ROOK_PIECE_ID),
            # Spaces
            ChessPiece(name="space", team_id=NULL_TEAM_ID, piece_id=SPACE_PIECE_ID),
            ChessPiece(name="space", team_id=NULL_TEAM_ID, piece_id=SPACE_PIECE_ID),
            # Blacks Side
            ChessPiece(name="black_rook", team_id=BLACK_TEAM_ID, piece_id=ROOK_PIECE_ID),
            ChessPiece(name="black_knight", team_id=BLACK_TEAM_ID, piece_id=KNIGHT_PIECE_ID),
            ChessPiece(name="black_king", team_id=BLACK_TEAM_ID, piece_id=KING_PIECE_ID),
        ]
